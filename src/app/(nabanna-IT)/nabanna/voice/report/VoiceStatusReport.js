          ...
          <tbody>
            {fetchData.map((data, index) => (
              <tr key={index}>
                ...
                <td className="w-[200px]">{data.remarks.split(":")[1].trim()}</td>
              </tr>
            ))}
          </tbody>
        </Table>
...
export default VoiceStatusReport;
